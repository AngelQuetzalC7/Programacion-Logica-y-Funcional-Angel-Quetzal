...
peliculas_Nolan = list(map(
    lambda pelicula: {'titulo': pelicula['Titulo'], 'calificacion': float(pelicula['CalificaciónIMDB'])},
...
print(f'Calificación promedio de películas de Christopher Nolan: {promedio:.2f}')