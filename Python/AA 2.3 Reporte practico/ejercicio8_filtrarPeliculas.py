...
lista_filtrada = list(filter(lambda pelicula: float(pelicula['CalificaciónIMDB']) >= 8.0, lista_peliculas))

nueva_lista = list(map(lambda pelicula: {'titulo': pelicula['Titulo'], 'calificacion': pelicula['CalificaciónIMDB']}, lista_filtrada))

print (json.dumps(nueva_lista, indent=2))
