...
#calificacionesFor = [{"Titulo": pelicula["Titulo"], "Calificacion": pelicula["CalificaciónIMDB"]} for pelicula in lista_peliculas]

ratin_peli = list(map(lambda pelicula: {"Titulo": pelicula["Titulo"], "Calificacion": pelicula["CalificaciónIMDB"]}, lista_peliculas))
#print(ratin_peli)
#print(calificacionesFor)

import json
print(json.dumps(ratin_peli, indent=2))